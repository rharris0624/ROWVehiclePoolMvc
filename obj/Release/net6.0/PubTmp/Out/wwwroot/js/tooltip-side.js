//  document.write "<style>#tipBox {position: absolute; width: 200px; z-index: 100; background: lightskyblue; visibility: hidden}</style>";
  ...
  function writeContents(el, tip) {
    ...
    if (allSupport)
      ...
      el.document.open()
      el.document.write("<TABLE WIDTH=200 BORDER=0 bordercolor=black><TR><TD WIDTH=100% BGCOLOR=lightskyblue>")
  ...
  function setPosition(el) {
    ...
    if (allSupport) {
      ...
      el.style.pixelRight = 20
      
    } else 
    {  
      el.top = src.y //window.event.y + 15
